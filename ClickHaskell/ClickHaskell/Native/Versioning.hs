...
_DBMS_MIN_REVISION_WITH_CLIENT_INFO :: Integer
_DBMS_MIN_REVISION_WITH_CLIENT_INFO = 54032;

_DBMS_MIN_REVISION_WITH_SERVER_TIMEZONE :: Integer
_DBMS_MIN_REVISION_WITH_SERVER_TIMEZONE = 54058;

_DBMS_MIN_REVISION_WITH_QUOTA_KEY_IN_CLIENT_INFO :: Integer
_DBMS_MIN_REVISION_WITH_QUOTA_KEY_IN_CLIENT_INFO = 54060;

_DBMS_MIN_REVISION_WITH_TABLES_STATUS :: Integer
_DBMS_MIN_REVISION_WITH_TABLES_STATUS = 54226;

_DBMS_MIN_REVISION_WITH_TIME_ZONE_PARAMETER_IN_DATETIME_DATA_TYPE :: Integer
_DBMS_MIN_REVISION_WITH_TIME_ZONE_PARAMETER_IN_DATETIME_DATA_TYPE = 54337;

_DBMS_MIN_REVISION_WITH_SERVER_DISPLAY_NAME :: Integer
_DBMS_MIN_REVISION_WITH_SERVER_DISPLAY_NAME = 54372;

_DBMS_MIN_REVISION_WITH_VERSION_PATCH :: Integer
_DBMS_MIN_REVISION_WITH_VERSION_PATCH = 54401;

_DBMS_MIN_REVISION_WITH_SERVER_LOGS :: Integer
...
_DBMS_TCP_PROTOCOL_VERSION :: Integer
